"use strict";var n=function(e,r){return function(){try{return r||e((r={exports:{}}).exports,r),r.exports}catch(u){throw (r=0, u)}};};var v=n(function(w,i){
...
var d=require('@stdlib/utils-constant-function/dist'),q=require('@stdlib/math-base-assert-is-nan/dist'),F=require('@stdlib/math-base-special-ln/dist'),C=require('@stdlib/constants-float64-ninf/dist'),P=require('@stdlib/constants-float64-ln-two/dist'),O=require('@stdlib/constants-float64-ln-pi/dist'),R=.5*(P-O);function b(e){var r,u;if(q(e)||e<=0)return d(NaN);return r=F(e),u=e*e,c;function c(t){return q(t)?NaN:t<0?C:R-r-t*t/(2*u)}}N.exports=b
